...
export function Button({ children, className = "", asChild, ...props }: ButtonProps | LinkButtonProps) {
  const styles = `inline-flex min-h-11 items-center justify-center rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 active:scale-[0.98] dark:bg-blue-500 dark:hover:bg-blue-400 ${className}`;
