...
export function OptionalResumeSections() {
  ...
  return <section><div className="grid gap-4 sm:grid-cols-2">{sectionOptions.map((section) => {
    ...
    {resume.optionalSections.length > 0 && <div className="mt-8 border-t border-slate-200/80 pt-7">
      <h3 className="text-base font-semibold text-slate-900">Added sections</h3>
      <p className="mt-1 text-xs text-slate-500">Drag a section to reorder how it appears on your resume.</p>
      <div className="mt-4 space-y-5">{resume.optionalSections.map((section, index) => (
        <div
          key={section}
          draggable
